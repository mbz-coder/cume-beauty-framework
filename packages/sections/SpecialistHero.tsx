  ...
  return (
    <section className="mx-auto max-w-[1400px] px-6 py-24 md:py-32">
      <motion.div {...fadeUpViewport} className="grid items-center gap-12 md:grid-cols-2">
        {imagemSrc ? (
          <div className="relative aspect-[4/5] overflow-hidden rounded-2xl bg-brand-nude">
            <Image
              src={imagemSrc}
              alt={imagemAlt}
              fill
          ...
          <div
            ...
            className="flex aspect-[4/5] items-center justify-center rounded-2xl bg-brand-nude text-brand-primaria-dark/50"
          >
        ...
        <div>
          <span className="text-xs font-medium tracking-wide text-brand-primaria-dark uppercase">
            {papel}
          </span>
          <h1 className="mt-3 font-display text-4xl text-brand-ink md:text-5xl">{nome}</h1>
          <p className="mt-6 text-lg text-brand-ink/75">{bio}</p>
          ...
          <div className="mt-8">
            {isConversion ? (
              <Link
                ...
                className={cn(
                  buttonVariants(),
                  "h-[52px] rounded-full bg-brand-primaria px-8 text-sm font-medium hover:bg-brand-primaria-dark"
                )}
              >
                Agendar avaliação
              </Link>
